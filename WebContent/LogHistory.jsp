...
<html>
  <head>
    ...
    <title>My JSP 'LogHistory.jsp' starting page</title>
  ...
  <jsp:include page="Header.jsp"></jsp:include>
   ...
   <div style=""><jsp:include page="AdminMenu.jsp"></jsp:include></div>
        ...
        <strong class="box_msg">Log History</strong>                	
          
                <table border="1"  style="" cellpadding="5px">                	
                
                	<tr>
                		<th class="f1">User Name</th>
                		...
                		<%
    					 int i=0;
    					 int count =0;     
						 Vector c = (Vector) request.getAttribute("log");
						 Iterator it = c.listIterator();						
						 while (it.hasNext()) {							
						RegistrationBean logh=(RegistrationBean) it.next();								
